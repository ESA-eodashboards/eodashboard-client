 ...
 */const Or=sr(class extends lr{constructor(i){if(super(i),i.type!==Pt.PROPERTY&&i.type!==Pt.ATTRIBUTE&&i.type!==Pt.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!yn(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===Qt||t===st)return t;const e=i.element,r=i.name;if(i.type===Pt.PROPERTY){if(t===e[r])return Qt}else if(i.type===Pt.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(r))return Qt}else if(i.type===Pt.ATTRIBUTE&&e.getAttribute(r)===t+"")return Qt;return vn(i),t}});var Ir="Expected a function",er=NaN,Sa="[object Symbol]",xa=/^\s+|\s+$/g,Ea=/^[-+]0x[0-9a-f]+$/i,$a=/^0b[01]+$/i,Ta=/^0o[0-7]+$/i,_a=parseInt,Aa=typeof Ut=="object"&&Ut&&Ut.Object===Object&&Ut,Ca=typeof self=="object"&&self&&self.Object===Object&&self,La=Aa||Ca||Function("return this")(),Da=Object.prototype,Va=Da.toString,Ma=Math.max,ka=Math.min,vi=function(){return La.Date.now()};function Ra(i,t,e){var r,n,o,a,s,l,c=0,u=!1,d=!1,f=!0;if(typeof i!="function")throw new TypeError(Ir);t=ir(t)||0,Re(e)&&(u=!!e.leading,d="maxWait"in e,o=d?Ma(ir(e.maxWait)||0,t):o,f="trailing"in e?!!e.trailing:f);function g(C){var G=r,dt=n;return r=n=void 0,c=C,a=i.apply(dt,G),a}function y(C){return c=C,s=setTimeout(B,t),u?g(C):a}function w(C){var G=C-l,dt=C-c,J=t-G;return d?ka(J,o-dt):J}function D(C){var G=C-l,dt=C-c;return l===void 0||G>=t||G<0||d&&dt>=o}function B(){var C=vi();if(D(C))return L(C);s=setTimeout(B,w(C))}function L(C){return s=void 0,f&&r?g(C):(r=n=void 0,a)}function W(){s!==void 0&&clearTimeout(s),c=0,r=l=n=s=void 0}function P(){return s===void 0?a:L(vi())}function tt(){var C=vi(),G=D(C);if(r=arguments,n=this,l=C,G){if(s===void 0)return y(l);if(d)return s=setTimeout(B,t),g(l)}return s===void 0&&(s=setTimeout(B,t)),a}return tt.cancel=W,tt.flush=P,tt}function Pa(i,t,e){var r=!0,n=!0;if(typeof i!="function")throw new TypeError(Ir);return Re(e)&&(r="leading"in e?!!e.leading:r,n="trailing"in e?!!e.trailing:n),Ra(i,t,{leading:r,maxWait:t,trailing:n})}function Re(i){var t=typeof i;return!!i&&(t=="object"||t=="function")}function Oa(i){return!!i&&typeof i=="object"}function Ia(i){return typeof i=="symbol"||Oa(i)&&Va.call(i)==Sa}function ir(i){if(typeof i=="number")return i;if(Ia(i))return er;if(Re(i)){var t=typeof i.valueOf=="function"?i.valueOf():i;i=Re(t)?t+"":t}if(typeof i!="string")return i===0?i:+i;i=i.replace(xa,"");var e=$a.test(i);return e||Ta.test(i)?_a(i.slice(2),e?2:8):Ea.test(i)?er:+i}var Ha=Pa;const rr=Li(Ha);/**
 * @license
 ...
 */const be=i=>i??st;var ct,Pe,Oe;class Hr extends nt{constructor(){super();A(this,ct,[]);A(this,Pe,Ae`
  ...
  `);this.layer=null,this.unstyled=!1,this.noShadow=!1,this.layerConfig=null,this.throttleDataChange=rr(M(this,de,Ai),1e3)}updated(e){if(e.has("layerConfig")){const r=this.layerConfig.type==="style"||this.layerConfig.style?100:1e3;this.throttleDataChange=rr(M(this,de,Ai),r),this.requestUpdate()}}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){vt(this,Zt,ma(this.layer,this.layerConfig)),Object.keys(x(this,bt)).length!==0&&vt(this,Zt,x(this,bt)),customElements.get("eox-jsonform")||console.error("Please import @eox/jsonform in order to use layerconfig");const e={disable_edit_json:!0,disable_collapse:!0,disable_properties:!0};return h`
      <style>
        ${x(this,Ie)}
      ...
      ${R(this.layerConfig,()=>h`
          ${R(this.layerConfig.legend,()=>h`
              <eox-layercontrol-layer-legend
                ...
                .layer=${this.layer}
                .layerLegend=${ga(this.layerConfig.legend,x(this,bt))}
              ></eox-layercontrol-layer-legend>
            `)}
  ...
  `);this.layer=null,this.tools=[],this.unstyled=!1,this.noShadow=!1,this.toolsAsList=!1,setTimeout(()=>{var e;this.embedded=((e=this.parentElement)==null?void 0:e.tagName)==="EOX-LAYERCONTROL-LAYER"})}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){const e=ya(this.tools,this.layer),r=Rr(this.tools,this.layer),n=e==null?void 0:e.length,o=r==null?void 0:r.length;return h`
      <style>
        ${x(this,ze)}
  ...
  `);this.group=null,this.idProperty="id",this.map=null,this.titleProperty="title",this.showLayerZoomState=!1,this.tools=[],this.unstyled=!1,this.noShadow=!1,this.toolsAsList=!1}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){var n,o;const e=!!((n=this.group)!=null&&n.get("layerControlExpand")),r=(o=Pr(this.group.getLayers()))==null?void 0:o.length;return h`
      ...
      ${R(this.group,()=>h`
        ...
        `)}
    `}}Xe=new WeakMap,We=new WeakMap,O(Yr,"properties",{group:{attribute:!1},idProperty:{attribute:"id-property"},map:{attribute:!1,state:!0},titleProperty:{attribute:"title-property",type:String},showLayerZoomState:{attribute:"show-layer-zoom-state",type:Boolean},tools:{attribute:!1},unstyled:{type:Boolean},noShadow:{type:Boolean},toolsAsList:{type:Boolean}});customElements.define("eox-layercontrol-layer-group",Yr);const Fa=i=>{const{layers:t,idProperty:e,titleProperty:r,renderRoot:n}=i,o=wn(()=>{i.requestUpdate(),i.dispatchEvent(new CustomEvent("changed",{bubbles:!0}))},50),a=()=>o();if(t&&(t.hasListener("change:length")&&(t==null||t.un("change:length",a)),t.on("change:length",a),t)){const s=n.querySelector("ul");da(t,e,r,i),ca(s,t,e,i)}};var Ge,Je;class Zr extends nt{constructor(){super();A(this,Ge,"");A(this,Je,`
  ...
  `);this.idProperty="id",this.layers=null,this.map=null,this.tools=void 0,this.titleProperty="title",this.showLayerZoomState=!1,this.unstyled=!1,this.noShadow=!1,this.toolsAsList=!1}firstUpdated(){Fa(this)}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){const e=this.layers?Pr(this.layers).reverse():[];return h`
      <style>
        ${x(this,Ge)}
        ${!this.unstyled&&x(this,Je)}
      </style>
    ...
    `}}Ke=new WeakSet,Wr=function(){Ua(this)},O(Xr,"properties",{idProperty:{attribute:"id-property"},layers:{attribute:!1},titleProperty:{attribute:"title-property",type:String},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-optional-list",Xr);const qa=(i,t)=>{t.jsonInput=i.target.value,t.requestUpdate()},nr=i=>{const t=JSON.parse(`{"data":${yr(i.jsonInput)}}`);Array.isArray(t.data)?t.data.forEach(e=>{i.eoxMap.addOrUpdateLayer(e)}):i.eoxMap.addOrUpdateLayer(t.data),i.jsonInput=null,i.requestUpdate()},za=(i,t)=>{t.urlInput=i.target.value,t.requestUpdate()};async function ja(i){const t=i.urlInput;if(i.wmsCapabilities=null,i.searchLoad=!0,i.requestUpdate(),!t)return!1;if(Vi(t)==="XYZ")return{Name:t};try{const e=await Mo(t);i.wmsCapabilities=e}catch{}finally{i.searchLoad=!1,i.requestUpdate()}return!1}const Ya=(i,t)=>{const{Name:e}=i,r=Vi(t.urlInput)||"XYZ",n={type:"Tile",properties:{id:e,title:e},source:{type:r,url:t.urlInput,params:{LAYERS:e}}};t.jsonInput=JSON.stringify(n)},Za=(i,t)=>{t.open=i||null,t.urlInput=null,t.jsonInput=null,t.wmsCapabilities=null,t.requestUpdate()};var j,Jr,Kr,Ci,Qr,tn,_e,Qe;class Gr extends nt{constructor(){super();A(this,j);O(this,"urlInput",null);O(this,"jsonInput",null);O(this,"open",null);O(this,"searchLoad",!1);O(this,"wmsCapabilities",null);A(this,Qe,`
  ...
  `);this.eoxMap=null,this.unstyled=!1,this.noShadow=!1}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){const e={add:h`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        />
      </svg>`},r=this.open?"open":"close",n=this.open==="url",o=this.open==="json",a=!ko(this.urlInput)||this.searchLoad?!0:st;return h`
      <style>
        ${x(this,Qe)}
      </style>
          ...
          ${n?h`
              ...
              `:h`
                ...
                <button
                  ...
                  disabled=${Ro(this.jsonInput)?st:!0}
                  @click=${M(this,j,Qr)}
                >
    ...
    `}}j=new WeakSet,Jr=function(e){za(e,this)},Kr=async function(){const e=await ja(this);e&&M(this,j,Ci).call(this,e)},Ci=function(e){Ya(e,this),nr(this)},Qr=function(){nr(this)},tn=function(e){qa(e,this)},_e=function(e){Za(e,this)},Qe=new WeakMap,O(Gr,"properties",{eoxMap:{attribute:!1,state:!0},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-add-layers",Gr);const Xa=(i,t)=>{if(t.requestUpdate(),i.target.tagName==="EOX-LAYERCONTROL-LAYER-TOOLS"){const e=t.renderRoot.querySelector("eox-layercontrol-optional-list");e==null||e.requestUpdate()}},or=i=>{const t=wi(i.for);return t&&t.map!==i.map&&(i.map=t.map),t};ar();var Lt,Vt,rn,nn,on,ti;class en extends nt{constructor(){super();A(this,Vt);A(this,Lt);A(this,ti,`
    ${ei}
    :host, :root {
      --padding: 0.5rem;
...
`;var U=function(i,t,e,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,e):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(i,t,e,r);else for(var s=i.length-1;s>=0;s--)(a=i[s])&&(o=(n<3?a(o):n>3?a(t,e,o):a(t,e))||o);return n>3&&o&&Object.defineProperty(t,e,o),o};let H=class extends nt{constructor(){super(...arguments),this.titleText=bs,this.width=ds,this.height=us,this.marginTop=hs,this.marginRight=ps,this.marginBottom=fs,this.marginLeft=gs,this.scaleType=Ss,this.domain=ys,this.range=vs,this.markType=ws,this.ticks=ln,this.tickFormat=cn,this.tickSize=ms,this.colorScaleSetter=new ls(this),this.axisTickSetter=new $s(this),this.renderer=new cs(this)}get interpolator(){return this._interpolator}set interpolator(t){if(typeof t=="function"){const e=this.interpolator;this._interpolator=t,this.requestUpdate("interpolator",e)}else throw new Error("interpolator must be a function.")}get tickFormatter(){return this._tickFormatter}set tickFormatter(t){if(typeof t=="function"){const e=this.tickFormatter;this._tickFormatter=t,this.requestUpdate("tickFormatter",e)}else throw new Error("tickFormatter must be a function.")}get colorScale(){return this.colorScaleSetter.colorScale}get xScale(){return this.axisTickSetter.xScale}render(){return this.renderer.render()}willUpdate(t){xs.some(e=>t.has(e))&&this.colorScaleSetter.setColorScale(),Es.some(e=>t.has(e))&&(this.axisTickSetter.setXScale(),this.axisTickSetter.handleAxisTicks())}};H.styles=[Ts];U([X({type:String})],H.prototype,"titleText",void 0);U([X({type:Number})],H.prototype,"width",void 0);U([X({type:Number})],H.prototype,"height",void 0);U([X({type:Number})],H.prototype,"marginTop",void 0);U([X({type:Number})],H.prototype,"marginRight",void 0);U([X({type:Number})],H.prototype,"marginBottom",void 0);U([X({type:Number})],H.prototype,"marginLeft",void 0);U([X({type:String})],H.prototype,"scaleType",void 0);U([X({type:Array})],H.prototype,"domain",void 0);U([X({type:Array})],H.prototype,"range",void 0);U([X({type:String})],H.prototype,"markType",void 0);U([X({type:Number})],H.prototype,"ticks",void 0);U([X({type:String})],H.prototype,"tickFormat",void 0);U([X({type:Number})],H.prototype,"tickSize",void 0);U([X({type:Array})],H.prototype,"tickValues",void 0);U([ss("svg")],H.prototype,"svg",void 0);U([X({attribute:!1})],H.prototype,"interpolator",null);U([X({attribute:!1})],H.prototype,"tickFormatter",null);H=U([rs("color-legend")],H);const _s={class:"d-flex flex-column"},As=["for"],Cs={slot:"layerstitle"},Ls={key:0,class:"mt-2 mb-2"},Ds={__name:"EodashLayerControl",props:{map:{type:String,default:"first"},tools:{type:Array,default:()=>["datetime","info","config","legend","opacity"]},title:{type:String||Boolean,default:"Layers"},cssVars:{type:Object}},setup(i){const t=i,e={tools:t.tools,style:t.cssVars},{selectedCompareStac:r,selectedStac:n}=Cn(Ln()),o=Pn(()=>t.map==="second"?Fi.value!==null&&r.value!==null:Ui.value!==null&&n.value!==null),a=t.map==="second"?Dn:Vn,s=t.map==="second"?Fi:Ui,l=On(null),c=async g=>{var W;const{layer:y,datetime:w}=g.detail,D=await Rn(a,y);let B=[];D&&(await D.fetchCollection(),B=await D.updateLayerJson(w,y.get("id"),t.map));const L=(W=B==null?void 0:B.find(P=>{var tt;return((tt=P==null?void 0:P.properties)==null?void 0:tt.id)==="AnalysisGroup"}))==null?void 0:W.layers;L!=null&&L.length&&(L==null||L.forEach(P=>{P.properties.layerControlExpand=!0,P.properties.layerControlToolsExpand=!0}),s.value.layers=B)};let u;const d=g=>{clearTimeout(u),u=setTimeout(()=>{c(g)},500)},f=g=>{t.map==="second"?Mn.value=g.detail.jsonformValue:kn.value=g.detail.jsonformValue};return(g,y)=>(ai(),oi("span",_s,[o.value?(ai(),oi("eox-layercontrol",In({key:0},e,{for:Hn(s),"onDatetime:updated":d,toolsAsList:"true",style:{"--eox-background-color":"transparent"},ref_key:"eoxLayercontrol",ref:l,"on:layerConfig:change":f}),[zi("div",Cs,[i.title?(ai(),oi("p",Ls,[zi("strong",null,Bn(i.title),1)])):qi("v-if",!0)])],16,As)):qi("v-if",!0)]))}},Ks=An(Ds,[["__scopeId","data-v-d9f4a4a6"]]);export{Ks as default};
