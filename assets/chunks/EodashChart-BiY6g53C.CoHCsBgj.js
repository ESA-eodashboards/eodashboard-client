import"./main.C8RWKuAU.js";import{o as v}from"./handling-CEHZ7XxB.B86W0Z51.js";import{_ as B,ak as O,al as s,am as z,an as M,ao as R,ap as T,aq as I,ar as N}from"./eo-dash.B8uRNfSp.js";import{T as q}from"./index-CtlUJxP6.SV6Q_kmW.js";import{q as D,a4 as V,v as L,Y as A,o as l,c as p,j as g,a2 as J,k as f,e as x,N as y,ax as b,p as w,h as i,P}from"./framework.BnhGnzLG.js";import"./lit-element.CIht5NN8.js";import"./addCommonStyleSheet.B0XXRREc.js";import"./sequential.BcvVcPN9.js";import"./orient2d.DArCjZZA.js";import"./async-CA54McI8.D5A291U9.js";import"./utils.BJtOAKhC.js";import"./index.CxojoGlr.js";import"./item.Tx4UuQzI.js";import"./commonjsHelpers.BosuxZz1.js";import"./main.0EmCobLd.js";import"./when.BR7zwNJC.js";import"./repeat.9Pq2frlr.js";import"./directive.CvdRHFdJ.js";import"./directive-helpers.BMu_cjfm.js";import"./unsafe-html.RlppLW26.js";import"./map.DiiNQ3pp.js";import"./XYZ._S3Kc2FN.js";import"./Object.DcVsVtBM.js";import"./index.BUIxO2d3.js";import"./getElement.COiK8z0h.js";import"./VTooltip-sU56bG-B.CPRl9Jfk.js";import"./forwardRefs-DGoJRqOz.DTJrDipK.js";import"./transition-CoZ4EDUi.FPm5Cqtt.js";const j=".bg-surface:has(.eodash-chart-wrapper){height:100%;display:flex;flex-direction:column}",F=".eodash-chart-wrapper[data-v-29f0a1a6]{height:100%;flex-grow:1;min-height:180px;display:flex;flex-direction:column}.chart-frame[data-v-29f0a1a6]{position:relative;flex-grow:1;min-height:180px;display:flex;flex-direction:column}eox-chart[data-v-29f0a1a6]{flex-grow:1;min-height:0}.chart-toggle[data-v-29f0a1a6]{position:absolute;top:8px;right:46px;z-index:2;cursor:pointer}",H={ref:"container",class:"eodash-chart-wrapper"},K={viewBox:"0 0 20 20",width:"20",height:"20","aria-hidden":"true"},U=["d"],Y=[".spec",".dataValues",".opt"],G={__name:"EodashChart",props:{enableCompare:{type:Boolean,default:!1},vegaEmbedOptions:{type:Object,default(){return{actions:!0}}}},setup(c){const d=i(()=>c.enableCompare?z.value:M.value),m=i(()=>c.enableCompare?R.value:T.value),C=i(()=>{const a=m.value;if(!a)return!1;let t=!1;const o=e=>{if(!(t||!e||typeof e!="object")){if("bind"in e&&typeof e.bind=="object"&&e.bind!==null&&"input"in e.bind){t=!0;return}Object.values(e).forEach(o)}};return o(a),t}),n=w(null);D(m,a=>{if(!a){n.value=null;return}const t=JSON.parse(JSON.stringify(a));t.height="container",t.width="container",P(()=>{n.value=t,u.value=Math.random(),setTimeout(()=>{window.dispatchEvent(new Event("resize"))},150)})},{immediate:!0});const u=w(0),_=V("container");let r=null,h=null;L(()=>{const a=_.value;if(!a)return;h=window.setInterval(()=>{if(a){const o=a.querySelector("eox-chart");if(o&&o.shadowRoot&&!o.shadowRoot.querySelector("#eodash-chart-styles")){const e=document.createElement("style");e.id="eodash-chart-styles",e.innerHTML=`
          ...
          `,o.shadowRoot.appendChild(e)}}},200);const t=O(a);t&&(r=new MutationObserver(async()=>{getComputedStyle(t).display!=="none"&&(u.value=Math.random())}),r.observe(t,{attributes:!0,attributeFilter:["style","class"]}))}),A(()=>{r==null||r.disconnect(),h&&window.clearInterval(h)});const S=i(()=>({height:"100%",width:"100%"})),k=i(()=>s.value?I:N);function E(){s.value=!s.value}return(a,t)=>(l(),p("div",H,[g("div",{class:"chart-frame",style:y({paddingBottom:C.value?"25px":"0px"})},[d.value&&m.value?J((l(),p("button",{key:0,class:"chart-toggle",onClick:E},[(l(),p("svg",K,[g("path",{d:k.value},null,8,U)]))])),[[q,f(s)?"Minimize":"Maximize"]]):x("v-if",!0),d.value&&n.value?(l(),p("eox-chart",{".spec":b(n.value),key:u.value,".dataValues":b(d.value),"onClick:item":t[0]||(t[0]=(...o)=>f(v)&&f(v)(...o)),style:y(S.value),".opt":c.vegaEmbedOptions},null,44,Y)):x("v-if",!0)],4)],512))}},_t=B(G,[["styles",[j,F]],["__scopeId","data-v-29f0a1a6"]]);export{_t as default};
