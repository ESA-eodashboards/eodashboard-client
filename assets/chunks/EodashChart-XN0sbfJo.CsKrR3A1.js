import"./main.C8RWKuAU.js";import{o as v}from"./handling-B4s45_Zu.CIkeBsZz.js";import{_ as B,ae as O,af as s,ag as z,ah as M,ai as R,aj as T,ak as I,al as N}from"./eo-dash.UlyJxv-3.js";import{T as D}from"./index-CUMRgV2V.D4k7Ua2l.js";import{q as V,a4 as q,v as L,Y as j,o as l,c as p,j as g,a2 as A,k as f,e as x,N as b,ax as y,p as w,h as i,P as J}from"./framework.BnhGnzLG.js";import"./lit-element.CIht5NN8.js";import"./addCommonStyleSheet.B0XXRREc.js";import"./sequential.BcvVcPN9.js";import"./orient2d.DArCjZZA.js";import"./async-FQLx9Sig.BEOWuLKg.js";import"./utils.BJtOAKhC.js";import"./index.CxojoGlr.js";import"./commonjsHelpers.BosuxZz1.js";import"./migrate.DkSLOl0d.js";import"./main.sj1zV-U7.js";import"./when.BR7zwNJC.js";import"./repeat.9Pq2frlr.js";import"./directive.CvdRHFdJ.js";import"./directive-helpers.BMu_cjfm.js";import"./unsafe-html.RlppLW26.js";import"./map.DiiNQ3pp.js";import"./XYZ._S3Kc2FN.js";import"./Object.DcVsVtBM.js";import"./index.BUIxO2d3.js";import"./getElement.COiK8z0h.js";import"./VTooltip-CN2hWikL.CRpFigr3.js";import"./forwardRefs-J0L8VwKK.B55YjzN3.js";import"./transition-Bt7KRCNn.BTA62x6V.js";const P=".bg-surface:has(.eodash-chart-wrapper){height:100%;display:flex;flex-direction:column}",F=".eodash-chart-wrapper[data-v-c14bc6fb]{height:100%;flex-grow:1;min-height:180px;display:flex;flex-direction:column}.chart-frame[data-v-c14bc6fb]{position:relative;flex-grow:1;min-height:180px;display:flex;flex-direction:column}eox-chart[data-v-c14bc6fb]{flex-grow:1;min-height:0}.chart-toggle[data-v-c14bc6fb]{position:absolute;top:8px;right:46px;z-index:2;cursor:pointer}",H={ref:"container",class:"eodash-chart-wrapper"},K={viewBox:"0 0 20 20",width:"20",height:"20","aria-hidden":"true"},U=["d"],Y=[".spec",".dataValues",".opt"],G={__name:"EodashChart",props:{enableCompare:{type:Boolean,default:!1},vegaEmbedOptions:{type:Object,default(){return{actions:!0}}}},setup(c){const d=i(()=>c.enableCompare?z.value:M.value),m=i(()=>c.enableCompare?R.value:T.value),C=i(()=>{const a=m.value;if(!a)return!1;let t=!1;const o=e=>{if(!(t||!e||typeof e!="object")){if("bind"in e&&typeof e.bind=="object"&&e.bind!==null&&"input"in e.bind){t=!0;return}Object.values(e).forEach(o)}};return o(a),t}),n=w(null);V(m,a=>{if(!a){n.value=null;return}const t=JSON.parse(JSON.stringify(a));t.height="container",t.width="container",J(()=>{n.value=t,u.value=Math.random(),setTimeout(()=>{window.dispatchEvent(new Event("resize"))},150)})},{immediate:!0});const u=w(0),_=q("container");let r=null,h=null;L(()=>{const a=_.value;if(!a)return;h=window.setInterval(()=>{if(a){const o=a.querySelector("eox-chart");if(o&&o.shadowRoot&&!o.shadowRoot.querySelector("#eodash-chart-styles")){const e=document.createElement("style");e.id="eodash-chart-styles",e.innerHTML=`
          ...
          `,o.shadowRoot.appendChild(e)}}},200);const t=O(a);t&&(r=new MutationObserver(async()=>{getComputedStyle(t).display!=="none"&&(u.value=Math.random())}),r.observe(t,{attributes:!0,attributeFilter:["style","class"]}))}),j(()=>{r==null||r.disconnect(),h&&window.clearInterval(h)});const S=i(()=>({height:"100%",width:"100%"})),k=i(()=>s.value?I:N);function E(){s.value=!s.value}return(a,t)=>(l(),p("div",H,[g("div",{class:"chart-frame",style:b({paddingBottom:C.value?"25px":"0px"})},[d.value&&m.value?A((l(),p("button",{key:0,class:"chart-toggle",onClick:E},[(l(),p("svg",K,[g("path",{d:k.value},null,8,U)]))])),[[D,f(s)?"Minimize":"Maximize"]]):x("v-if",!0),d.value&&n.value?(l(),p("eox-chart",{key:u.value,".spec":y(n.value),".dataValues":y(d.value),style:b(S.value),".opt":c.vegaEmbedOptions,"onClick:item":t[0]||(t[0]=(...o)=>f(v)&&f(v)(...o))},null,44,Y)):x("v-if",!0)],4)],512))}},_t=B(G,[["styles",[P,F]],["__scopeId","data-v-c14bc6fb"]]);export{_t as default};
