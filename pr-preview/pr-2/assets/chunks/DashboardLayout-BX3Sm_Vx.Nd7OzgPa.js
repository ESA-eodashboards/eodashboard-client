import{b as r,o as a,w as u,j as f,N as d,k as o,c as i,e as h,aA as m,H as y,K as g,F as x,B as b,T as _}from"./framework.Cb3DMKwX.js";import{x as v,aU as w}from"./eo-dash.BxePgG7O.js";import{V as k}from"./VMain-eZDKIfmJ.JGgeH5W7.js";import"./commonjsHelpers.BosuxZz1.js";import"./ssrBoot-BP7SYRyC.1OXalhEw.js";class A extends HTMLElement{static get observedAttributes(){return["gap"]}constructor(){super(),this.attachShadow({mode:"open"}),this.render()}render(){this.shadowRoot.innerHTML=`
    <style>
      :host {
        display: grid;
