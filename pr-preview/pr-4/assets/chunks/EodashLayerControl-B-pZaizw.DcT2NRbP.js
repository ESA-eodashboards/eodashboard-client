 ...
 */const Mn=nn(class extends on{constructor(i){if(super(i),i.type!==Ot.PROPERTY&&i.type!==Ot.ATTRIBUTE&&i.type!==Ot.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!go(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===Qt||t===tt)return t;const e=i.element,n=i.name;if(i.type===Ot.PROPERTY){if(t===e[n])return Qt}else if(i.type===Ot.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(n))return Qt}else if(i.type===Ot.ATTRIBUTE&&e.getAttribute(n)===t+"")return Qt;return mo(i),t}});var On="Expected a function",Ji=NaN,ba="[object Symbol]",wa=/^\s+|\s+$/g,xa=/^[-+]0x[0-9a-f]+$/i,Sa=/^0b[01]+$/i,Ea=/^0o[0-7]+$/i,Ca=parseInt,$a=typeof Ut=="object"&&Ut&&Ut.Object===Object&&Ut,Ta=typeof self=="object"&&self&&self.Object===Object&&self,_a=$a||Ta||Function("return this")(),Aa=Object.prototype,Da=Aa.toString,La=Math.max,ka=Math.min,gi=function(){return _a.Date.now()};function Ra(i,t,e){var n,o,r,a,s,l,c=0,u=!1,d=!1,p=!0;if(typeof i!="function")throw new TypeError(On);t=Ki(t)||0,Pe(e)&&(u=!!e.leading,d="maxWait"in e,r=d?La(Ki(e.maxWait)||0,t):r,p="trailing"in e?!!e.trailing:p);function f(A){var G=n,dt=o;return n=o=void 0,c=A,a=i.apply(dt,G),a}function y(A){return c=A,s=setTimeout(B,t),u?f(A):a}function w(A){var G=A-l,dt=A-c,J=t-G;return d?ka(J,r-dt):J}function L(A){var G=A-l,dt=A-c;return l===void 0||G>=t||G<0||d&&dt>=r}function B(){var A=gi();if(L(A))return D(A);s=setTimeout(B,w(A))}function D(A){return s=void 0,p&&n?f(A):(n=o=void 0,a)}function W(){s!==void 0&&clearTimeout(s),c=0,n=l=o=s=void 0}function M(){return s===void 0?a:D(gi())}function et(){var A=gi(),G=L(A);if(n=arguments,o=this,l=A,G){if(s===void 0)return y(l);if(d)return s=setTimeout(B,t),f(l)}return s===void 0&&(s=setTimeout(B,t)),a}return et.cancel=W,et.flush=M,et}function Pa(i,t,e){var n=!0,o=!0;if(typeof i!="function")throw new TypeError(On);return Pe(e)&&(n="leading"in e?!!e.leading:n,o="trailing"in e?!!e.trailing:o),Ra(i,t,{leading:n,maxWait:t,trailing:o})}function Pe(i){var t=typeof i;return!!i&&(t=="object"||t=="function")}function Ma(i){return!!i&&typeof i=="object"}function Oa(i){return typeof i=="symbol"||Ma(i)&&Da.call(i)==ba}function Ki(i){if(typeof i=="number")return i;if(Oa(i))return Ji;if(Pe(i)){var t=typeof i.valueOf=="function"?i.valueOf():i;i=Pe(t)?t+"":t}if(typeof i!="string")return i===0?i:+i;i=i.replace(wa,"");var e=Sa.test(i);return e||Ea.test(i)?Ca(i.slice(2),e?2:8):xa.test(i)?Ji:+i}var Ia=Pa;const Qi=Ti(Ia);/**
 * @license
 ...
 */const be=i=>i??tt;var ct,Me,Oe;class In extends rt{constructor(){super();T(this,ct,[]);T(this,Me,$i`
  ...
  `);this.idProperty="id",this.layers=null,this.map=null,this.tools=void 0,this.titleProperty="title",this.showLayerZoomState=!1,this.unstyled=!1,this.noShadow=!1,this.toolsAsList=!1}firstUpdated(){Na(this)}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){const e=this.layers?Pn(this.layers).reverse():[];return m`
    ...
    `}}Je=new WeakSet,Zn=function(){Ha(this)},O(Yn,"properties",{idProperty:{attribute:"id-property"},layers:{attribute:!1},titleProperty:{attribute:"title-property",type:String},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-optional-list",Yn);const Fa=(i,t)=>{t.jsonInput=i.target.value,t.requestUpdate()},tn=i=>{const t=JSON.parse(`{"data":${mn(i.jsonInput)}}`);Array.isArray(t.data)?t.data.forEach(e=>{i.eoxMap.addOrUpdateLayer(e)}):i.eoxMap.addOrUpdateLayer(t.data),i.jsonInput=null,i.requestUpdate()},Ua=(i,t)=>{t.urlInput=i.target.value,t.requestUpdate()};async function ja(i){const t=i.urlInput;if(i.wmsCapabilities=null,i.searchLoad=!0,i.requestUpdate(),!t)return!1;if(Ai(t)==="XYZ")return{Name:t};try{const e=await Ar(t);i.wmsCapabilities=e}catch{}finally{i.searchLoad=!1,i.requestUpdate()}return!1}const za=(i,t)=>{const{Name:e}=i,n=Ai(t.urlInput)||"XYZ",o={type:"Tile",properties:{id:e,title:e},source:{type:n,url:t.urlInput,params:{LAYERS:e}}};t.jsonInput=JSON.stringify(o)},qa=(i,t)=>{t.open=i||null,t.urlInput=null,t.jsonInput=null,t.wmsCapabilities=null,t.requestUpdate()};var q,Wn,Gn,Ci,Jn,Kn,Te,Ke,Qe;class Xn extends rt{constructor(){super();T(this,q);O(this,"urlInput",null);O(this,"jsonInput",null);O(this,"open",null);O(this,"searchLoad",!1);O(this,"wmsCapabilities",null);T(this,Ke,`
  ...
  `);this.eoxMap=null,this.unstyled=!1,this.noShadow=!1}createRenderRoot(){return this.noShadow?this:super.createRenderRoot()}render(){const e=this.open?"open":"close",n=this.open==="url",o=this.open==="json",r=!Dr(this.urlInput)||this.searchLoad?!0:tt;return m`
    ...
    `}}q=new WeakSet,Wn=function(e){Ua(e,this)},Gn=async function(){const e=await ja(this);e&&R(this,q,Ci).call(this,e)},Ci=function(e){za(e,this),tn(this)},Jn=function(){tn(this)},Kn=function(e){Fa(e,this)},Te=function(e){qa(e,this)},Ke=new WeakMap,Qe=new WeakMap,O(Xn,"properties",{eoxMap:{attribute:!1,state:!0},unstyled:{type:Boolean},noShadow:{type:Boolean}});customElements.define("eox-layercontrol-add-layers",Xn);const Ya=(i,t)=>{if(t.requestUpdate(),i.target.tagName==="EOX-LAYERCONTROL-LAYER-TOOLS"){const e=t.renderRoot.querySelector("eox-layercontrol-optional-list");e==null||e.requestUpdate()}},en=i=>{const t=yi(i.for);return t&&t.map!==i.map&&(i.map=t.map),t};var Dt,kt,to,eo,io,ti;class Qn extends rt{constructor(){super();T(this,kt);T(this,Dt);T(this,ti,`
    :host, :root {
...
`,Ws={__name:"EodashLayerControl",props:{map:{type:String,default:"first"},tools:{type:Array,default:()=>["datetime","info","config","legend","opacity"]},cssVars:{type:Object}},setup(i){const t=i,e={tools:t.tools,style:t.cssVars},{selectedCompareStac:n,selectedStac:o}=To(_o()),r=Ro(()=>t.map==="second"?Bi.value!==null&&n.value!==null:Ni.value!==null&&o.value!==null),a=t.map==="second"?Ao:Do,s=t.map==="second"?Bi:Ni,l=Po(null),c=async f=>{var W;const{layer:y,datetime:w}=f.detail,L=await ko(a,y);let B=[];L&&(await L.fetchCollection(),B=await L.updateLayerJson(w,y.get("id"),t.map));const D=(W=B==null?void 0:B.find(M=>{var et;return((et=M==null?void 0:M.properties)==null?void 0:et.id)==="AnalysisGroup"}))==null?void 0:W.layers;D!=null&&D.length&&(D==null||D.forEach(M=>{M.properties.layerControlExpand=!0,M.properties.layerControlToolsExpand=!0}),s.value.layers=B)};let u;const d=f=>{clearTimeout(u),u=setTimeout(()=>{c(f)},500)},p=f=>{Lo.value=f.detail.jsonformValue};return(f,y)=>(Fi(),Hi("span",Cs,[r.value?(Fi(),Hi("eox-layercontrol",Oo({key:0},e,{for:Io(s),"onDatetime:updated":d,class:"fill-height",toolsAsList:"true",style:{"--eox-background-color":"transparent"},ref_key:"eoxLayercontrol",ref:l,"on:layerConfig:change":p,".styleOverride":Ts}),null,48,$s)):Mo("v-if",!0)]))}};export{Ws as default};
